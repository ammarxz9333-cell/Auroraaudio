...
for f in "$BOOT" "$SYSTEM" \
         ...
         "$ROOT/docs/acceptance/AURORA_SYSTEM_ARCHITECTURE_HARDENING_ACCEPTANCE.md" \
         "$ROOT/docs/AURORA_USB_S6_REALTIME_MCU_PROTOCOL.md"; do
...
install -m 0644 "$ROOT/docs/AURORA_USB_S6_REALTIME_MCU_PROTOCOL.md" "$STAGE/docs/AURORA_USB_S6_REALTIME_MCU_PROTOCOL.md"

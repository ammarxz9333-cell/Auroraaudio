...
last-RX time, and the selected gPTP grandmaster without claiming the pinned
...
def check(root: Path) -> None:
    ...
    required_source = (
        "state->ptp_status.clock_source_info.id",
        "stream->connected",

...
| Deterministic fixtures | PASS | Three repeated Windows runs plus Linux CI; target-qualified quantized checksums; `deterministic_simulation` |
...
- Irregular sweep: 21 spread values by 721 source angles, repeated with
  quantized checksums `0ef1fc03dfa5892e` on Windows and `6c25035a72424f0f`
  on Linux.

...
/// quality measurements. Evidence gates decide whether a backend may actually
...
const BACKENDS: &[BackendDescriptor] = &[
    BackendDescriptor {
        ...
        name: "OpenJOC E-AC-3 JOC object decoder",
    ...
    BackendDescriptor {
        ...
        name: "OxideAV AC-4 + Aurora object-preserving OAMD bridge",
        execution: ExecutionClass::NativeRust,
        license: LicenseClass::ProprietaryCompatiblePermissive,
        integrated: true,
        closed_core_compatible: true,
        ...
        robustness: 88,
        latency: 95,
        metadata_fidelity: 92,
        portability: 99,
        codecs: OXIDE_AC4_CODECS,
    },
    BackendDescriptor {
        id: BackendId::TrueHdNative,
        name: "truehd/truehdd TrueHD Atmos object decoder",
        execution: ExecutionClass::NativeRust,
        license: LicenseClass::ProprietaryCompatiblePermissive,
        integrated: false,
        closed_core_compatible: true,
    ...
    BackendDescriptor {
        id: BackendId::FfmpegDtsHd,
        name: "FFmpeg DTS-HD HR/MA/XLL decoder",
    ...
    BackendDescriptor {
        id: BackendId::LibIamfReference,
        name: "AOM libiamf v1.1 reference decoder",
    ...
    BackendDescriptor {
        ...
        name: "AOM iamf-tools alternate IAMF implementation",
        execution: ExecutionClass::NativeLibrary,
        license: LicenseClass::ProprietaryCompatiblePermissive,
        integrated: false,
        closed_core_compatible: true,
    ...
    BackendDescriptor {
        id: BackendId::LibMpegH,
        name: "Ittiam libmpegh MPEG-H 3D Audio reference decoder",
        execution: ExecutionClass::NativeLibrary,
    ...
    BackendDescriptor {
        ...
        name: "FFmpeg general compatibility worker",
        execution: ExecutionClass::ExternalWorker,
        license: LicenseClass::WeakCopyleftExternal,
        integrated: true,
        closed_core_compatible: true,
